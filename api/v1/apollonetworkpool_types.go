...
type ApolloNetworkPoolSpec struct {
	...
	// Foo is an example field of ApolloNetworkPool. Edit apollonetworkpool_types.go to remove/update
...
// ApolloNetworkPool is the Schema for the apollonetworkpools API.
